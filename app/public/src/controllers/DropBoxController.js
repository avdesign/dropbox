class DropBoxController {
    ...
    constructor(){
        ...
        this.onselectionchange = new Event('selectiononchange');
    ...
    connectFirebase(){
        ...
        // Initialize Firebase
        var config = {
            apiKey: "AIzaSyD9TUpzzkUI-U_H3yYDugsO0ZwTCQDrXXE",
            authDomain: "drop-box-avdesign.firebaseapp.com",
            databaseURL: "https://drop-box-avdesign.firebaseio.com",
            projectId: "drop-box-avdesign",
            storageBucket: "drop-box-avdesign.appspot.com",
            messagingSenderId: "956071957758"
        };
    ...
    initEvents(){
        ...
        this.listFilesEl.addEventListener('selectiononchange', e => {

            //console.log('selectiononchange', this.getSelection().length);
